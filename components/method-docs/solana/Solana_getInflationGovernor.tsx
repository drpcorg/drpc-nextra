...
export function Solana_getInflationGovernor() {
  return (
    <SolanaMethod
    ...
    childrenParams: [
        {
          ...
          type: "number",
          paramDescription: "The share of total inflation assigned to the foundation",
        },
        {
          paramName: "foundationTerm",
          type: "number",
          paramDescription: "The duration, in years, over which the foundation's allocation will be distributed",
        },
        {
          paramName: "initial",
          type: "number",
          paramDescription: "The starting inflation rate from the beginning",
        },
        {
          paramName: "taper",
          type: "number",
          paramDescription: "The period, in years, over which the inflation rate decreases from the initial to the terminal rate",
        },
        {
          paramName: "terminal",
          type: "number",
          paramDescription: "The final, steady-state inflation rate",
        },
    ],
  },
];
