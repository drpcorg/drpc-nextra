...
export function Solana_signatureUnsubscribe() {
  return (
    <SolanaMethod
...
# wait for connection
{"id":1,"jsonrpc":"2.0","method":"signatureUnsubscribe","params":[0]}
`,
  },
  {
    language: "js",
...
const USE_CASES = [
  "Unsubscribe from specific transaction signature notifications",
  "Stop receiving updates for a signature subscription",
  "Manage and cancel active signature subscriptions",
];

const CONSTRAINTS = [
  "Requires an active signature subscription ID",
  "Disconnection may lead to missed confirmations",
  "Only valid for current WebSocket connections",
];
