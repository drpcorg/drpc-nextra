...
export function Solana_getLeaderSchedule() {
  return (
    <SolanaMethod
      ...
      responseParamsDescription={
        "Contains block production information, including details about the current epoch, the total number of blocks produced, and the number of leader slots assigned to each validator."
      }
    />
  );
}
...
const REQUEST_PARAMS: RequestParamProp = [
   {
    paramName: "u64",
    type: "string",
    paramDescription: " Retrieves the leader schedule for the epoch corresponding to the given slot. If not specified, it fetches the schedule for the current epoch"
   },
   {
    paramName: "identity",
    type: "string",
    paramDescription: "Returns results only for the specified validator identity, encoded as a base-58 string."
  },
   {
