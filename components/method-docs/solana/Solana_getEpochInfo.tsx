...
export function Solana_getEpochInfo                                                                   () {
  return (
    <SolanaMethod
      method="getEpochInfo"
      network="solana"
...
const RESPONSE_PARAMS: ReqResParam[] = [
  ...
  },
  {
    ...
    childrenParams: [
        {
          paramName: "absoluteSlot",
          type: "integer",
          paramDescription: "The current slot number."
        },
        {
          paramName: "blockHeight",
          type: "integer",
          paramDescription: "The current height of the blockchain."
        },
        {
          paramName: "epoch",
          type: "integer",
          paramDescription: "The current epoch number."
        },
        {
          paramName: "slotIndex",
          type: "integer",
          paramDescription: "The index of the current slot within the epoch"
        },
        {
          paramName: "slotsInEpoch",
          type: "integer",
          paramDescription: "The total number of slots in the current epoch"
        },
        {
          paramName: "transactionCount",
          type: "integer",
          paramDescription: "The total number of transactions processed in the current epoch."
        },
    ],
  },
];
