...
export function Solana_getMinimumBalanceForRentExemption() {
  return (
    <SolanaMethod
      ...
      responseParamsDescription={
        "The minimum amount of lamports an account must have to avoid paying rent, represented as a 64-bit unsigned integer (u64)"
      }
    />
  );
}
...
const REQUEST_PARAMS: RequestParamProp = [
  {
    paramName: "usize",
    type: "string",
    paramDescription: "The length of the account data"
   },
   {
