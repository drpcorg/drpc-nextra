...
export function Solana_getHighestSnapshotSlot() {
  return (
    <SolanaMethod
    ...
    childrenParams: [
        {
          paramName: "full",
          type: "integer",
          paramDescription: "The highest full snapshot slot, represented as a 64-bit unsigned integer",
        },
        {
          paramName: "incremental",
          type: "integer",
          paramDescription: "The highest incremental snapshot slot derived from the full snapshot.",
        },
    ],
  },
];
