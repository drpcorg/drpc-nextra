...
export function Solana_getTokenAccountsByOwner() {
  return (
    <SolanaMethod
...
func main() {
	...
	requestBody, err := json.Marshal(map[string]interface{}{
		...
		"params":  []interface{}{
			"GgPpTKg78vmzgDtP1DNn72CHAYjRdKY7AV6zgszoHCSa",
			map[string]interface{}{"mint": "1YDQ35V8g68FGvcT85haHwAXv1U7XMzuc4mZeEXfrjE"},
        ...
        childrenParams: [
          {
            ...
            type: "boolean",
            paramDescription: "Indicates if the account contains a program and is read-only.",
          },
          {
            paramName: "lamports",
            type: "integer",
            paramDescription: "The total lamports allocated to this account.",
          },
          {
            paramName: "owner",
            type: "string",
            ...
            paramName: "rentEpoch",
            type: "integer",
            paramDescription: "The epoch at which the token account will be subject to rent",
          },
            {
            paramName: "space",
            type: "integer",
            paramDescription: "The storage capacity required for the token account.",
          },
          {
            paramName: "account",
            type: "string",
            ...
            childrenParams: [
              ...
              },
              {
                paramName: "program",
                type: "string",
                paramDescription: "The program responsible for managing the token.\n",
              },
              {
                paramName: "data",
                type: "string",
