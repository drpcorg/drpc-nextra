...
import {DRPC_ENDPOINT_URL_SUPERSEED_WSCAT} from "./constants";
...
export function SuperseedMethod_unsubscribe() {
  return (
    <EthereumMethod_unsubscribe
      replaceCodeSnippetsURLFrom={DRPC_ENDPOINT_URL_WSCAT}
      replaceCodeSnippetsURLTo={DRPC_ENDPOINT_URL_SUPERSEED_WSCAT}
      network="superseed"
    />
  );
}
