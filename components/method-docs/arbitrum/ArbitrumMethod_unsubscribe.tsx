...
import {DRPC_ENDPOINT_URL_ARBITRUM, DRPC_ENDPOINT_URL_ARBITRUM_WSCAT} from "./constants";
...
export function ArbitrumMethod_unsubscribe() {
  return (
    <EthereumMethod_unsubscribe
      replaceCodeSnippetsURLFrom={DRPC_ENDPOINT_URL_WSCAT}
      replaceCodeSnippetsURLTo={DRPC_ENDPOINT_URL_ARBITRUM_WSCAT}
      network="arbitrum"
    />
  );
}
