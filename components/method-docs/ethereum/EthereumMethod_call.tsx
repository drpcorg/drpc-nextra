...
const CONSTRAINTS = [
  ...
  "dRPC has a gas cap of 600 million (600M) for eth_call. If your call requires more gas than this limit, the request will fail. If you need a higher gas limit, please contact our support team.",
];
