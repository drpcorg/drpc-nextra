...
export function EthereumMethod_web3_sha3(
...
func main() {
	...
	requestBody, err := json.Marshal(map[string]interface{}{
		"jsonrpc": "2.0",
		"method":  "web3_sha3",
		"params":  []interface{}{"0x68656c6c6f20776f726c64"},
		"id": 1
	})
...
const REQUEST_PARAMS: RequestParamProp = [
    {
      paramName: "data",
      type: "string",
      paramDescription: "The data to be hashed. The input data should be a hexadecimal string."
    }
];
