...
const REQUEST_PARAMS: RequestParamProp = [
    {
      paramName: "height",
      type: "string",
      paramDescription: "The height of the block for which the header information is being requested. If omitted, the header for the latest block is returned."
    },
];
