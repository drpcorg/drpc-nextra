...
<Meta
  title="Ethereum and Mantle: Differences | dRPC"
  description={`Mantle is a Layer 2 scaling solution based on the OP Stack architecture. While it shares design elements with Ethereum, there are important differences for developers transitioning between the two platforms.`}
/>
