...
const url = 'https://lb.drpc.live/optimism/YOUR_DRPC_API_KEY';
...
Replace `‘https://lb.drpc.live/optimism/YOUR_DRPC_API_KEY'` with the actual endpoint URL you obtained from dRPC.
