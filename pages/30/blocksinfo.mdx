...
<Meta
  ...
  description="The Blocks Info group retrieves detailed data from a specified block on the Arbitrum network, including transactions, receipts, and block-specific details."
/>
