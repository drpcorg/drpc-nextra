...
2. The one that has the lowest and the most stable latency, error probability, and the price. We want request to be served as fast as possible, without errors and at the lowest price for a client.
