...
If you call a method that is not a part of this table, the default cost is 100 CU. If you think something is wrong, ask in [our discord](https://discord.gg/drpc).
