...
When you're **Paid Tier** DRPC user and have enabled `JSON web token` in your key settings, JWTs are used as addiitonal layer of security to authenticate your requests.
...
const privateKey = fs.readFileSync("../private.pem");
    ...
    const GENERATED_JWT = jwt.sign({}, privateKey, signOptions);
