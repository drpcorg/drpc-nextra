...
Selector `#eth_call` converts to `1000`:

1. method selector (1)
2. network selector (0)
3. archive selector (0)
4. all selector (0)

Selector `$metis archive` converts to `0110`:

1. method selector (0)
2. network selector(1)
3. archive selector (1)
4. all selector (0)

Now we just compare those 2 numbers and `1000` > `0110`, so the selector `#eth_call`
